...
["Desktop Text", -1, IDC_MMC_DLG_DESKTOP_CONTENT, "Select an app on the left.", "desktopContent", "Text shown on the user's Desktop screen. Use \n or <br/> for line breaks."] call _addEdit;
